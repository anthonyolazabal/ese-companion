        ...
        await this.$axios
          ...
          .then(() => {
            ...
            if (this.$route.query.return == "details") {
              router.push('/mqtt-accounts-details?id=' + this.$route.query.id);
            } else {
  ...
  <VRow>
    <VCol cols="12" md="12">
      <v-breadcrumbs>
        ...
        <v-breadcrumbs-item>
          <RouterLink :to="'/mqtt-accounts-edit?id' + $route.query.id">
            Edit Account
          </RouterLink>
        </v-breadcrumbs-item>
    ...
    <VCol cols="12">
      <VCard title="Edit a MQTT accounts">
        <VCardText>
