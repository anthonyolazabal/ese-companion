...
values ('HIVEMQ_SUPER_ADMIN', 'special cc_permission, that allows access to everything'),
       ...
       ('HIVEMQ_EDIT_DATA_CLIENT_CONNECTION_STATE', 'allowed to edit client connection state'),
       ...
       ('HIVEMQ_EDIT_DATA_SUBSCRIPTION', 'allowed to add/delete client subscriptions'),
       ...
       ('HIVEMQ_EDIT_DATA_SESSION_STATE', 'allowed to edit session state'),
...
values ('HIVEMQ_SUPER_ADMIN', 'special rest_api_permission, that allows access to everything'),
       ...
       ('HIVEMQ_MQTT_CLIENTS_SEARCH_GET', 'allows GET on /api/v1/mqtt/clients/search'),
       ...
       ('HIVEMQ_MANAGEMENT_DIAGNOSTIC_ARCHIVES_WRITE', 'allows POST on /api/v2/management/diagnostic-archives endpoint'),
       ('HIVEMQ_MANAGEMENT_DIAGNOSTIC_ARCHIVES_READ', 'allows GET on /api/v2/management/diagnostic-archives/* endpoints')
;
