...
set CLASSPATH=%APP_HOME%\lib\ese-companion-all.jar

@rem Execute ese-companion
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ESE_COMPANION_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ESE_COMPANION_EXIT_CONSOLE%" exit 1
exit /b 1
